...
Use the `filter()` function to remove the SNPs and samples that do not satisfy the user criteria.
...
```{r eval=FALSE}
snpdata <- impute(snpdata, genotype = "GT", nsim = 100)
