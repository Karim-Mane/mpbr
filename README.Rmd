...
The functions in the {{ packagename }} require a **SNPdata** object. This can be generated with the `get_snpdata()` function.   
...
The vignette of the {{ packagename }} contains detailed illustrations about the use of each function. This can be accessed by typing the command below:
